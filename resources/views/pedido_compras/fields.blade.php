            ...
            <div class="row">
                ...
                <div class="form-group col-xl-3 col-md-6">
                    ...
                    <div class="input-group pedido-input-group">
                        ...
                        {!! Form::date(
                            'ped_fecha',
                            isset($pedido) && !empty($pedido->ped_fecha)
                                ? \Carbon\Carbon::parse($pedido->ped_fecha)->format('Y-m-d')
                                : \Carbon\Carbon::now()->format('Y-m-d'),
                            ['class' => 'form-control', 'id' => 'ped_fecha'],
                        ) !!}
                    </div>
                </div>
                ...
                <div class="form-group col-xl-3 col-md-6">
                    ...
                    <div class="input-group pedido-input-group">
                        ...
                        {!! Form::select('cod_suc_visual', $sucursal, $codSucursalPedido, [
                            'class' => 'form-control',
                            'disabled' => true,
                        ]) !!}
                    </div>
                ...
                <div class="form-group col-xl-3 col-md-5">
                    ...
                    <div class="input-group pedido-input-group">
                        ...
                        {!! Form::select('condicion', $condicion, $pedido->condicion ?? null, [
                            'class' => 'form-control',
                            'id' => 'condicion',
                        ]) !!}
                ...
                <div class="form-group col-xl-3 col-md-6">
                    ...
                    <div class="pedido-radio-group">
                        <label class="pedido-radio-option" for="descuento_si">
                            {!! Form::radio('aplica_descuento', 'SI', isset($pedido) && (float) ($pedido->descuento ?? 0) > 0, [
                                'id' => 'descuento_si',
                                'class' => 'pedido-radio-input',
                            ]) !!}
                            <span class="pedido-radio-box"><i class="fas fa-check"></i></span><span>Sí</span>
                        </label>
                        <label class="pedido-radio-option" for="descuento_no">
                            {!! Form::radio('aplica_descuento', 'NO', !isset($pedido) || (float) ($pedido->descuento ?? 0) <= 0, [
                                'id' => 'descuento_no',
                                'class' => 'pedido-radio-input',
                            ]) !!}
                ...
                <div class="form-group col-xl-3 col-md-6" id="div-intervalo" style="display:none;">
                    ...
                    <div class="input-group pedido-input-group">
                        ...
                        {!! Form::number('intervalo', $pedido->intervalo ?? null, [
                            'class' => 'form-control',
                            'min' => 1,
                            'id' => 'intervalo',
                        ]) !!}
                ...
                <div class="form-group col-xl-3 col-md-6" id="div-cantcuotas" style="display:none;">
                    ...
                    <div class="input-group pedido-input-group">
                        <div class="input-group-prepend"><span class="input-group-text"><i
                                    class="fas fa-list-ol"></i></span></div>
                        {!! Form::number('cant_cuotas', $pedido->cant_cuotas ?? null, [
                            'class' => 'form-control',
                            'min' => 1,
                            'id' => 'cant_cuotas',
                        ]) !!}
                ...
                <div class="form-group col-xl-6 col-12">
                    ...
                    <div class="input-group pedido-input-group pedido-textarea-group">
                        ...
                        {!! Form::textarea('obs', $pedido->obs ?? null, [
                            'class' => 'form-control',
                            'placeholder' => 'Ingrese una observación opcional para el pedido',
                            'rows' => 2,
                            'style' => 'resize:none;',
                        ]) !!}
                    </div>
...
<div class="col-12 mt-3">
    <div class="pedido-total-panel">
        <div class="pedido-total-info">
            ...
            <div><span class="pedido-total-caption">Total del pedido</span><small>El total se actualiza automáticamente
                    según cantidades y descuento.</small></div>
        </div>
...
<button id="btnScroll" type="button" class="btn pedido-scroll-btn" onclick="toggleScroll()" title="Ir al final"><i
        id="iconScroll" class="fas fa-arrow-down"></i></button>
...
<style>
    ...
    .pedido-form-section-header p {
        margin: 4px 0 0;
        color: #000000;
        font-size: 12px
    }

    .pedido-form-section-body {
    ...
    .pedido-input-group .input-group-text {
        min-width: 42px;
        justify-content: center;
        border-color: #dce3eb;
        color: #668095;
    ...
    .pedido-input-group .form-control,
    .pedido-select-shell .form-control {
        min-height: 40px;
        border-color: #dce3eb;
        color: #000000;
        background: #fff;
    ...
    .pedido-input-group .form-control:focus,
    .pedido-select-shell .form-control:focus {
        border-color: #80aaf8;
        box-shadow: 0 0 0 2px rgba(37, 99, 235, .08)
    }

    .pedido-input-group .form-control[readonly],
    .pedido-input-group select:disabled {
        color: #000000;
        background: #f7f9fc
    }

    .pedido-textarea-group .input-group-text {
        align-items: flex-start;
        padding-top: 11px
    }

    .pedido-textarea-group textarea.form-control {
        min-height: 64px
    }
    ...
    .pedido-select-control {
        min-width: 0;
        flex: 1
    }

    .pedido-select-shell .select2-container {
        width: 100% !important
    }

    .pedido-select-shell .select2-container .select2-selection--single {
        height: 40px !important;
        border-color: #dce3eb !important;
        border-radius: 0 4px 4px 0 !important
    }

    .pedido-select-shell .select2-container .select2-selection--single .select2-selection__rendered {
    ...
    .pedido-select-shell .select2-container .select2-selection--single .select2-selection__arrow {
    ...
    #descuento_si:checked+.pedido-radio-box {
        color: #fff;
        background: #03b143
    }

    #descuento_no:checked+.pedido-radio-box {
        color: #fff;
        background: #d40707
    }
    ...
    .pedido-total-field .form-control {
        height: 44px;
        border: 1px solid #bfd2ee;
    ...
    .pedido-scroll-btn.show {
        opacity: 1;
        visibility: visible;
        transform: translateY(0)
    }

    .pedido-scroll-btn:hover {
        color: #fff;
        background: #1d4ed8
    }
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('#productSearchQueryPed').on('keyup', function() {
                ...
                timeout = setTimeout(function() {
                    if (query.length < 4) {
                        $('#modalResultsPed').html(
                            '<div class="text-center text-muted p-4"><i class="fas fa-search mb-2 d-block"></i>Escriba al menos 4 caracteres...</div>'
                        );
                        return;
                    }
            ...
            $('#descuento_input').on('input', function() {
                let valor = normalizarNumeroPedido(this.value),
                    error = document.getElementById('error-descuento');
                if (valor > 100) {
                    this.value = 100;
        ...
        function fetchProductos(query, cod_suc) {
            fetch('{{ url('buscar-productos-ped') }}?query=' + encodeURIComponent(query || '') + '&cod_suc=' +
                ...
                .then(function(html) {
                    let c = document.getElementById('modalResultsPed');
                    if (c) c.innerHTML = html;
                })
                .catch(function() {
                    let c = document.getElementById('modalResultsPed');
                    if (c) c.innerHTML =
                        '<div class="text-center text-danger p-4">No se pudieron cargar los productos.</div>';
                });
        }
        ...
        function cargarDetalleEdit() {
            let detalle = @json($detalle ?? []),
                tabla = document.getElementById('selectedProducts');
        ...
        function seleccionarProductoPed(codigo, producto, precio) {
            ...
            let existe = Array.from(tabla.querySelectorAll("input[name='codigo[]']")).some(function(i) {
                return i.value === codigo;
            });
            if (existe) {
                Swal.fire({
                    icon: 'warning',
                    title: 'Producto ya agregado',
                    text: 'Solo podés modificar la cantidad en la tabla.',
                    timer: 1500,
                    showConfirmButton: false,
                    toast: true,
                    position: 'top-end',
            ...
            setTimeout(function() {
                row.style.transition = 'background-color .5s';
        ...
        function calcularTodo(completarVacios = false) {
            ...
            let e = document.getElementById('totalCantidad');
            if (e) e.innerText = totalCantidad;
            let m = document.getElementById('modalCantidadProductos');
            if (m) m.innerText = totalCantidad;
            calcularTotal();
        }
        ...
        function calcularTotal() {
            ...
            let p = document.getElementById('ped_total');
            if (p) p.value = formatearMiles(total);
            let m = document.getElementById('modalTotalPedido');
            if (m) m.innerText = formatearMiles(total);
        }
        ...
        function toggleScroll() {
            if (scrollMode === 'top') window.scrollTo({
                top: 0,
                behavior: 'smooth'
            });
        ...
        window.addEventListener('scroll', function() {
            let btn = document.getElementById('btnScroll'),
                icon = document.getElementById('iconScroll');
            if (!btn || !icon) return;
            let scrollTop = window.scrollY,
                docHeight = document.documentElement.scrollHeight,
                windowHeight = window.innerHeight;
            if (scrollTop > 200) btn.classList.add('show');
