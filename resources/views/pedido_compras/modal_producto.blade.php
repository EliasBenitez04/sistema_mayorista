...
@push('page_scripts')
    <script>
        ...
        /* =========================================================
           ...
           La lógica real del detalle está definida en fields.blade.php.
           No duplicar aquí seleccionarProductoPed(), calcularTotal()
           ni borrarFila(), porque provoca conflictos de precio/subtotal.
        ========================================================= */
        ...
        function seleccionarProductoPedDesdeFila(fila) {
            ...
            // Firma original y estable del formulario:
            // seleccionarProductoPed(codigo, producto, precio)
            seleccionarProductoPed(codigo, producto, precio);
        }
